    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="font-display font-bold text-2xl text-gray-900 mb-1">Vocabulary</h1>
          <p className="text-sm text-gray-500 text-center">
            ইংরেজি শব্দভাণ্ডার শেখার সেরা উপায়
          </p>
        </div>
        ...
        <div className="card p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-150 shadow-sm"
          >
            {/* Google SVG icon */}
